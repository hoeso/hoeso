...
INSERT IGNORE  INTO user (Host, User, Password) VALUES ('localhost','fcs', password(''));
...
INSERT IGNORE  INTO db (Host, Db, User, Select_Priv, Insert_Priv, Update_Priv, Delete_Priv, Lock_tables_priv) VALUES ('localhost','cfs','fcs','Y','N','N','N','Y');
